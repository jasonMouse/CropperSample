...
/**
 * ImgCropHandleHelper class to handle corner Handles (i.e. top-left, top-right, bottom-left, and
 * bottom-right handles).
 */
class ImgCropCornerHandleHelper extends ImgCropHandleHelper {

    // Constructor /////////////////////////////////////////////////////////////////////////////////

    ImgCropCornerHandleHelper(ImgCropEdge horizontalEdge, ImgCropEdge verticalEdge) {
    ...
    void updateCropWindow(float x,
        ...
        final ImgCropEdgePair activeEdges = getActiveEdges(x, y, targetAspectRatio);
